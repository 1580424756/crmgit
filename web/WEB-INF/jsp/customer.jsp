            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody><%--controller层model.addaAtribble将从数据库中得到的数据，一下全部传进来--%>
                        <c:forEach items="${page.rows}" var="row">
                            <tr>
                                ...
                                <td>
                                    <%--bootstrrap属性 " data-toggle="modal"指定为模态框 data-target指向id为这个的模态框   --%>
...
<div class="modal fade" id="customerEditDialog" tabindex="-1" role="dialog"
    ...
    <%--aria-labelledby=“myModalLabel”将这个标签内id为myModalLabel的作为这个模态框的标题--%>
